[![Build Status](https://travis-ci.org/Steampunk1453/RetroApp.svg?branch=master)](https://travis-ci.org/Steampunk1453/RetroApp)
...
To optimize the RetroApp application for production, run:
